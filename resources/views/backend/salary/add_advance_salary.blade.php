...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <!-- justify-content-center added to center the form -->
        <div class="row justify-content-center">
            
            <!-- col-lg-8 used for better form width -->
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="advance_salary" class="form-control @error('advance_salary') is-invalid @enderror" id="advance_salary">
