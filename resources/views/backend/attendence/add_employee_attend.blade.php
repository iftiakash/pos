                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <h4>
                                <a href="{{ route('employee.attend.list') }}" class="btn btn-primary float-sm-right">
                        ...
                        <form action="{{ route('employee.attend.store') }}" method="post" id="myForm">
                            ...
                            <table class="table table-bordered table-striped dt-responsive" style="width: 100%">
                                <thead>
                                    ...
                                    <tr>
                                        <th class="text-center btn present_all" style="background-color:#114190">Present</th>
                                        <th class="text-center btn leave_all" style="background-color:#114190">Leave</th>
                                        <th class="text-center btn absent_all" style="background-color:#114190">Absent</th>
                                    </tr>
                                </thead>
